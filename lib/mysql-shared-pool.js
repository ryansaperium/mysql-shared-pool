...
function MySqlSharedPool(config) {
    ...
    // expose knex functionalities here as needed
    this.schema = this._pool.schema;
    this.table = this._pool.table;
}

MySqlSharedPool.prototype.raw = function(query, params) {
    if (this._destroyed) {
...
MySqlSharedPool.prototype.schema;
MySqlSharedPool.prototype.table;
